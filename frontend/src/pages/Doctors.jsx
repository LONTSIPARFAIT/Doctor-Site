  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        <button onClick={()=>setShowFilter(prev => !prev)} className={`py-1 px-3 border rounded text-sm transition-all lg:visible sm:hidden ${showFilter ? 'bg-[#5f6FFF] text-white' : 'border-gray-300'} `}>Filtres</button>
