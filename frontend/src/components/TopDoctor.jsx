...
const TopDoctor = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      <h1 className="text-3xl font-medium md:text-4xl">Les meilleurs médecins à réserver</h1>
      ...
      <button onClick={()=>{ navigate('/doctors'); scrollTo(0,0)}} className="bg-blue-50 cursor-pointer text-gray-600 px-12 py-3 rounded-full mt-10">Plus</button>
    </div>
  );
};
